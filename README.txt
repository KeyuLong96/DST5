...
The data is huge ~500GB what make a great project to build data science portfolio. However, we are not going to build model on the whole data set just its subset, say 1GB for training data and 1GB of testing data. We will build beta version in colab and once we build the model we’ll move to BC4. There is 512GB available storage space in BC4, exact amount of free space we need for our model :). We agreed to proceed as follows:
